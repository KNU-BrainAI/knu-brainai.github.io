...
- Natural Language Processing ![]({{ site.url }}{{ site.baseurl }}/images/bert.jpg){: style="width: 400px; float: right"} 
 ...
 - Electrophysiology ![]({{ site.url }}{{ site.baseurl }}/images/eeg.png){: style="width: 400px; float: right"} 
 
   Electrophysiology, refers to the electrical recording of neuronal events ranging from the molar (electroencephalogram, EEG) to the cellular (intracellular recording of the properties of single neurons), is one of the primary research areas in neurophysiology. To understand electrophysiological signals, modern digital signal processing techniques including the traditional basics of signal processing are needed. We study state-of-the-art signal processing techniques to analyze electrophysiological signals from the brain and use our techniques to help various fields such as dianosis of psychiatric diseases.
